...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for yousysadmin/jc2headscale

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ~/.bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/yousysadmin/jc2headscale/releases
...
execute() {
  ...
  http_download "${tmpdir}/${CHECKSUM_FILE_NAME}" "${CHECKSUM_FILE_URL}"
  hash_sha256_verify "${tmpdir}/${TARBALL}" "${tmpdir}/${CHECKSUM_FILE_NAME}"
