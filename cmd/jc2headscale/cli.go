...
func init() {
	...
	cliCmd.PersistentFlags().StringVar(&inputPolicyFile, "input-policy", "./policy.json", "Headscale policy file template")
	cliCmd.PersistentFlags().StringVar(&outputPolicyFile, "output-policy", "./out.json", "Headscale prepared policy file")
